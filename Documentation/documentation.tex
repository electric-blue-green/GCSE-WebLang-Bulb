...
~\par
\noindent\includegraphics[width=0.5\textwidth, left]{Picture18.png}
...
~\par
\noindent\includegraphics[width=0.5\textwidth, left]{Picture20.png} \par
This section simply styles for the three traffic lights, with their starting colours
\paragraph{FlexItem CSS}
~\par
\noindent\includegraphics[width=0.5\textwidth, left]{Picture21.png} \par
...
\end{lstlisting}
\subsubsection{Full Code}
\noindent\includegraphics[width=0.46\textwidth, left]{Picture22.png} \par
\subsubsection{Live Run}
The code was entered into a HTML document and opened in Safari. Screenshots: \par
\noindent\includegraphics[width=0.57\textwidth, left]{Picture23.png} \par
\noindent\includegraphics[width=0.57\textwidth, left]{Picture24.png} \par
\noindent\includegraphics[width=0.57\textwidth, left]{Picture25.png} \par
\noindent\includegraphics[width=0.57\textwidth, left]{Picture26.png} \par
...
\noindent\includegraphics[width=1\textwidth, left]{Picture27.png} \par
\noindent\includegraphics[width=1\textwidth, left]{Picture28.png} \par
\noindent\includegraphics[width=1\textwidth, left]{Picture29.png} \par \newpage
\subsection{Full Run}
A video of the full run can be found here: https://www.screencast.com/t/gexVA0T3YM
\paragraph{Stills} ~\par
\noindent\includegraphics[width=0.8\textwidth, left]{Picture30.png} \par 
Detail of wait button activated: \par \par
\noindent\includegraphics[width=0.2\textwidth, left]{Picture31.png} \par 
Dialogue box: \par
\noindent\includegraphics[width=1\textwidth, left]{Picture32.png} \par 
\newpage
\section{Task 5}
